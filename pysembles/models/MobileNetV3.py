...
'''
Copied this file form https://github.com/ShowLo/MobileNetV3/blob/master/mobileNetV3.py
Props to ShowLo for the implementation. 
'''
...
class MobileNetV3(nn.Module):
    ...
    '''
    def __init__(self, mode='small', classes_num=1000, input_size=224, width_multiplier=1.0, dropout=0.2, BN_momentum=0.1, zero_gamma=False, in_channels = 3):
        '''
        ...
        mode = mode.lower()
        assert mode in ['large', 'small', 'tiny']
        s = 2
        ...
        if mode == 'large':
            ...
            # Configuration of a MobileNetV3-Tiny Model
            # NOTE: BEWARE. This was not published. I - more or less - randomly removed
            #       layers / reduced the overall size. 
            configs = [
                #kernel_size, exp_size, out_channels_num, use_SE, NL, stride
                [3, 16, 16, True, 'RE', s],
                [3, 72, 24, False, 'RE', 2],
        ...
        first_layer = nn.Sequential(
            nn.Conv2d(in_channels=in_channels, out_channels=input_channels_num, kernel_size=3, stride=s, padding=1, bias=False),
